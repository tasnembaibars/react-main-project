...
const Dashboard = () => {
    ...
    useEffect(
        () => {
            axios.get(`http://127.0.0.1:8000/api/costumers`)
                                ...
                                <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                    ...
                                                    <h2 class="mb-4 text-dark font-weight-bold">{cos.length}</h2>
                                        ...
                                        <div class="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                    <h5 class="mb-2 text-dark font-weight-normal">Services</h5>
                                                    <h2 class="mb-4 text-dark font-weight-bold">{service.length}</h2>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                    <h5 class="mb-2 text-dark font-weight-normal">Posts</h5>
                                                    <h2 class="mb-4 text-dark font-weight-bold">{posts.length}</h2>
