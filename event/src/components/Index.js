                            ...
                            <div class="wpo-product-wrap">
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="wpo-product-item">
                                            <div class="wpo-product-img">
                                                <img src="assets/images/portfolio/24.jpg" alt="" style={{ height:"400px"}}/>
                                            ...
                                            <div class="wpo-product-text">
                                                <h3>
                                                    <div class="submit-area" >
                                                        ...
                                                        <button type="submit" name='like' class="theme-btn-s4" style={{ width: " 230px", color:"white"}}>  <NavLink to={`/catogry/1`} style={{ textDecoration: " none", color: "white" }}>Cutlery</NavLink> </button>
                                                    </div></h3>
                                                <span></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="wpo-product-item">
                                            <div class="wpo-product-img">
                                                <img src="assets/images/portfolio/333.jpg" alt="" style={{ height:"400px"}} />
                                            ...
                                            <div class="wpo-product-text">
                                                <h3>
                                                    <div class="submit-area" >
                                                        ...
                                                        <button type="submit" name='like' class="theme-btn-s4" style={{ width: " 230px", color:"white"}}>  <NavLink to={`/catogry/2`} style={{ textDecoration: " none", color: "white" }}>Welcome Signs</NavLink> </button>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="wpo-product-item">
                                            <div class="wpo-product-img">
                                                <img src="assets/images/portfolio/set.jpg" alt="" style={{ height:"400px"}} />
                                            ...
                                            <div class="wpo-product-text">
                                                <h3>
                                                    <div class="submit-area" >
                                                        ...
                                                        <button type="submit" name='like' class="theme-btn-s4" style={{ width: " 230px" ,color:"white"}}>   <NavLink to={`/catogry/3`} style={{ textDecoration: " none", color: "white" }}>Rings Set</NavLink> </button>
                                                    </div>  </h3>
                                                <span></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-13">
                                        <div class="wpo-product-item">
                                            <div class="wpo-product-img">
                                                <img src="assets/images/portfolio/3333.jpg" alt="" style={{ height:"400px"}}/>
                                            ...
                                            <div class="wpo-product-text">
                                                <h3>
                                                    <div class="submit-area" >
                                                        ...
                                                        <button type="submit" name='like' class="theme-btn-s4" style={{ width: " 230px", color:"white"}}>  <NavLink to={`/catogry/4`} style={{ textDecoration: " none", color: "white" }}>Themes</NavLink> </button>
                                                    </div> </h3>
                                                <span></span>
                                            </div>
                                        </div>
